...
class InventoryPeriod extends React.Component {
    ...
    onLineChanged() {
        console.log("inside linechanged");
        this.myRef.current.chartInstance.$datalabels._datasets[0].hidden = !this.myRef.current.chartInstance.$datalabels._datasets[0].hidden;
        ...
        return(
            <div className="col-xl-8 col-lg-6 col-sm-6 col-12 mt-2 mb-2 pl-0 pr-0 pr-lg-3 pr-sm-0">
                <Container className="inventory-period">
                    <Container>
                        <Button onClick={this.onLineChanged}></Button>
                    </Container>
